...
public class FoodMain implements Login
{
	...
	public void login()
	{
		...
		System.out.println("---------------------------------------------------");
		System.out.println("To place order please login");
		System.out.println("Create your username");
		Variables.setUsername(sc.next());
		System.out.println("Create your password");
		Variables.setPassword(sc.next());
		
		
		// Keep asking the user for input until a valid 16-digit card number is entered
        while(true) 
        {
            System.out.println("Enter your Card number: ");
            v.setCardNo(sc.next());

            if (isValidcardNo(v.getCardNo())) 
                break;
            else
                System.out.println("Invalid CardNo.\nPlease enter a valid 16-digit number.\n");
        }

	    System.out.println("Username and password Registered..");
		System.out.println("\n");
	}
	
	// Function to validate the card number format
    static boolean isValidcardNo(String cardNo)
    {
        if (cardNo.length() != 16) 
        {
            return false; // Not 16 digits
        }

        try 
        {
            Long.parseLong(cardNo); // Attempt to parse the string as a long
            return true; // Valid ATM number
	...
	{
    	BufferedWriter bfw =new BufferedWriter(new FileWriter("D:\\NIT\\Restaurant_Data.txt",true));
		...
		while(!v.isValidCode())
		{
			...
			else if(v.getOpt()==2)
			{
				...
				else if(v.getOpt()==2)
				{
					...
					System.out.println("\n-----------------------------------------------------------------------------------------------");
					System.out.println("\n-----------------------------------------------------------------------------------------------");
					System.out.println("******************************WELCOME TO BEST BIRIYANI RESTUARANT******************************");
					System.out.println("\n                                                                    |"+v.formattedDateTime+"|  ");
					System.out.println("-----------------------------------------------------------------------------------------------");
					Thread.sleep(3000);
					System.out.println("-----------------------------------------------------------------------------------------------");
					...
					for(int i=0; i<=v.getCount(); i++)
					{
						...
						System.out.println((i+1)+".                "+ v.getName()[index[i]-1] +"       "+ v.getPrice()[index[i] - 1]+"             "+quantity+" 		    "+result	);
					}
					System.out.println("-----------------------------------------------------------------------------------------------");
					Thread.sleep(3000);
					//Total Bill 
					...
					//checking username and passward
						while(!v.isValidCode())
						{
							System.out.println("Enter your username");
							String username_V=sc.next();
							System.out.println("Enter your password");
							String password_V=sc.next();
							
							if(username_V.equals(Variables.getUsername())&& password_V.equals(Variables.getPassword()))
							{
								System.out.println("\nPayment options: ");
								...
								{	
									...
									{									
										...
										if(v.getCardNo().equals(cardNo_v))
										{
											System.out.println("-----------------------------------------------------------------------------------------------");
											System.out.println("***********************************************************************************************");
											System.out.println(v.getUname().toUpperCase()+", Your Order has been Placed!!\nYour order will be delivered within 30 minutes");
											System.out.println("-----------------------------------------------------------------------------------------------");
											System.out.println("***********************************************************************************************");
						...
						}	//end of username and passward
					}	//end of while payment option	
